function cleanCooling(baseDir)
    ...
    [baseEEG72] = initializeWindows(EEG{1}.srate,EEG{1}.nbchan,EEG{1}.chanlocs);
    
    
    endTime = fileInfo.Date_Time(1) + hours(72);
    ...
    for i=1:length(EEG)
        ...
        if i==1
            pointEnd = EEG{i}.pnts;
            baseEEG72.data(:,1:pointEnd) = EEG{i}.data;
            [baseEEG72.event(1,1:length(EEG{i}.event)).type]=allType{:};
            [baseEEG72.event(1,1:length(EEG{i}.event)).edftype]=allEdfType{:};
            [baseEEG72.event(1,1:length(EEG{i}.event)).urevent]=allUrEvent{:};
            [baseEEG72.event(1,1:length(EEG{i}.event)).latency]=allLatency{:};
            baseEEG72 = eeg_checkset(baseEEG72,'eventconsistency');
        else
            
            pointStart = sum([timeBetweenLast{1:i}]);
            pointStart=hours(pointStart)*60*60*baseEEG72.srate;
            pointEnd = (EEG{i}.pnts-1)+pointStart;
            allLatency = num2cell(cellfun(@(x) x+pointStart,allLatency));
            baseEEG72.data(:,pointStart:pointEnd) = EEG{i}.data;
            if length(baseEEG72.event(:))>0
                startIndex = length(baseEEG72.event(:))+1;
            else
                startIndex=1;
            end
            [baseEEG72.event(1,startIndex:startIndex+length(EEG{i}.event)-1).type]=allType{:};
            [baseEEG72.event(1,startIndex:startIndex+length(EEG{i}.event)-1).edftype]=allEdfType{:};
            [baseEEG72.event(1,startIndex:startIndex+length(EEG{i}.event)-1).urevent]=allUrEvent{:};
            [baseEEG72.event(1,startIndex:startIndex+length(EEG{i}.event)-1).latency]=allLatency{:};
            baseEEG72 = eeg_checkset(baseEEG72,'eventconsistency');
        end
    ...
    for i=1:9
        switch i
            case 1
                ...
                baseEEG8 = pop_select(baseEEG72,'point',[1 8*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 2
                ...
                baseEEG16 = pop_select(baseEEG72,'point',[8*60*60*baseEEG72.srate+1 8*2*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 3
                ...
                baseEEG24 = pop_select(baseEEG72,'point',[8*2*60*60*baseEEG72.srate+1 8*3*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 4
                ...
                baseEEG32 = pop_select(baseEEG72,'point',[8*3*60*60*baseEEG72.srate+1 8*4*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 5
                ...
                baseEEG40 = pop_select(baseEEG72,'point',[8*4*60*60*baseEEG72.srate+1 8*5*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 6
                ...
                baseEEG48 = pop_select(baseEEG72,'point',[8*5*60*60*baseEEG72.srate+1 8*6*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 7
                ...
                baseEEG56 = pop_select(baseEEG72,'point',[8*6*60*60*baseEEG72.srate+1 8*7*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 8
                ...
                baseEEG64 = pop_select(baseEEG72,'point',[8*7*60*60*baseEEG72.srate+1 8*8*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
            ...
            case 9
                baseEEG72 = pop_select(baseEEG72,'point',[8*8*60*60*baseEEG72.srate+1 8*9*60*60*baseEEG72.srate],'channel',1:baseEEG72.nbchan);
    ...
    function [baseEEG72]=initializeWindows(srate,nbchan,chanlocs)
        baseEEG72 = eeg_emptyset();

        baseEEG72.srate = srate;
        baseEEG72.nbchan = nbchan;
        baseEEG72.chanlocs = chanlocs;
        baseEEG72.data(1:baseEEG72.nbchan,1:(72*60*60)*baseEEG72.srate)=0;
        baseEEG72.event = struct('type', {}, 'edftype',{},'urevent',{},'latency',{});
        baseEEG72 = eeg_checkset(baseEEG72);
