function cleanFollowup(baseDir)
    ...
    if ~exist(fullfile(baseDir,'Output_Followup_Files'),'dir')
        mkdir(fullfile(baseDir,'Output_Followup_Files'));
    end
    outputDir = 'Output_Followup_Files';
    ...
    for i=1:6
        switch i
            case 1
                ...
                baseEEG8.etc.processStep = 'Followup';
            ...
            case 2
                ...
                baseEEG16.etc.processStep = 'Followup';
            ...
            case 3
                ...
                baseEEG24.etc.processStep = 'Followup';
            ...
            case 4
                ...
                baseEEG32.etc.processStep = 'Followup';
            ...
            case 5
                ...
                baseEEG40.etc.processStep = 'Followup';
            ...
            case 6
                ...
                baseEEG48.etc.processStep = 'Followup';
