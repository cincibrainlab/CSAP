function cleanNonCooling(baseDir)
    ...
    if ~exist(fullfile(baseDir,'Output_Non_Cooling_Files'),'dir')
        mkdir(fullfile(baseDir,'Output_Non_Cooling_Files'));
    end
    outputDir = 'Output_Non_Cooling_Files';
    ...
    for i=1:6
        switch i
            case 1
                ...
                baseEEG8.etc.processStep = 'Non_Cooling';
            ...
            case 2
                ...
                baseEEG16.etc.processStep = 'Non_Cooling';
            ...
            case 3
                ...
                baseEEG24.etc.processStep = 'Non_Cooling';
            ...
            case 4
                ...
                baseEEG32.etc.processStep = 'Non_Cooling';
            ...
            case 5
                ...
                baseEEG40.etc.processStep = 'Non_Cooling';
            ...
            case 6
                ...
                baseEEG48.etc.processStep = 'Non_Cooling';
